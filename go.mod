...
replace (
	...
	k8s.io/component-helpers => k8s.io/component-helpers v0.20.3
	k8s.io/controller-manager => k8s.io/controller-manager v0.20.3
	...
	k8s.io/kubernetes => k8s.io/kubernetes v1.20.3

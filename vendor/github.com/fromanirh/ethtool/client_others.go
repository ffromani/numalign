...
func (c *client) ChannelInfos() ([]*ChannelInfo, error)         { return nil, errUnsupported }
func (c *client) ChannelInfo(_ Interface) (*ChannelInfo, error) { return nil, errUnsupported }
